...
- This pattern's introduction in the course: [Introduction to Tree Level Order Traversal Pattern](https://www.designgurus.io/course-play/grokking-the-coding-interview/doc/introduction-to-tree-breadth-first-search-pattern)
