...
- This pattern's introduction in the course: [Introduction to Backtracking Pattern](https://www.designgurus.io/course-play/grokking-the-coding-interview/doc/introduction-to-backtracking-pattern)
